...
const WorkoutEditor = () => {
  ...
  const handleAutoGenerated = (newExercises: Exercise[]) => {
    const states: WorkoutExerciseState[] = newExercises.map(ex => ({
      exercise: ex,
      sets: [
              ...
              <div className="flex flex-col">
                ...
                >
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div className={`p-1 transition-transform duration-300 ${expandedEx === exIdx ? 'rotate-180' : ''}`}>
